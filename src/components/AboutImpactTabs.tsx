...
import { Bot, Users, Trophy, Target, Heart, Globe, Lightbulb, Award, Star } from 'lucide-react';
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <Tabs defaultValue="first" className="w-full">
          ...
          <TabsContent value="first" className="space-y-12">
            <ScrollReveal>
              <div className="text-center mb-12">
                <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto font-inter leading-relaxed mb-8">
                ...
                <div className="bg-glass-card/50 backdrop-blur-xl border border-white/10 rounded-3xl p-6 max-w-4xl mx-auto">
                  <blockquote className="text-xl md:text-2xl font-inter text-white/90 italic leading-relaxed">
                  ...
                  <cite className="block mt-4 text-base text-primary font-semibold">- Dean Kamen, FIRST Founder (adapted with our Christian mission)</cite>
                </div>
              </div>
            </ScrollReveal>
