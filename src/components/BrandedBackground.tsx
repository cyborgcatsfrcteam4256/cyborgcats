    ...
    <div className={`relative ${className}`}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-10 left-10 opacity-5">
          <img src={cyborgCatsLogo} alt="" className="w-32 h-32 rotate-12" />
        </div>
        
        {/* Center logo */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-3">
          <img src={cyborgCatsLogo} alt="" className="w-64 h-64 -rotate-6" />
        </div>
        
        {/* Bottom right logo */}
        <div className="absolute bottom-10 right-10 opacity-5">
          <img src={cyborgCatsLogo} alt="" className="w-24 h-24 rotate-45" />
        </div>
