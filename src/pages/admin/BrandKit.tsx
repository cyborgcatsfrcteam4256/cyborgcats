...
import { Loader2, Save, Palette, Type, Eye, Download } from "lucide-react";
...
export default function AdminBrandKit() {
  ...
  const downloadBrandKit = () => {
    const content = `
CYBORG CATS FRC TEAM 4256 - BRAND KIT
=====================================

COLOR PALETTE
-------------
Primary Color: ${brandData.primary_color}
Primary Glow: ${brandData.primary_glow_color}
Primary Electric: ${brandData.primary_electric_color}
Secondary Color: ${brandData.secondary_color}
Accent Color: ${brandData.accent_color}

TYPOGRAPHY
----------
Display Font: ${brandData.font_display}
Body Font: ${brandData.font_body}
Monospace Font: ${brandData.font_mono}
...
MISSION
-------
${brandData.mission_brief}

LOGO USAGE GUIDELINES
--------------------
${brandData.logo_usage_guidelines}
...
Generated: ${new Date().toLocaleDateString()}
    ...
    a.href = url;
    a.download = 'cyborg-cats-brand-kit.txt';
    ...
    toast({
      title: "Downloaded",
      description: "Brand kit guidelines have been downloaded.",
    });
  };
        ...
        <Card className="border-primary/20">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button type="button" variant="outline" onClick={downloadBrandKit}>
