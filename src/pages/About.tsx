...
const teamPhoto = '/lovable-uploads/team-operating.jpg';
...
const About = () => {
  ...
  const milestones = [
    { year: '2011', event: 'Team Founded', description: 'Cyborg Cats established at Westminster Christian Academy' },
    { year: '2015', event: 'First Regional Win', description: 'Won our first regional competition in St. Louis' },
    { year: '2018', event: 'World Championship', description: 'Competed at FIRST Championship in Detroit' },
    { year: '2021', event: 'Innovation Award', description: 'Recognized for STEM Companion Initiative' },
    { year: '2023', event: 'International Expansion', description: 'Helped establish FRC team in South Korea' },
    { year: '2025', event: 'Impact Award', description: 'Won prestigious FIRST Impact Award' }
  ];

  const leadership = [
    { role: 'Engineering Lead', name: 'Coming Soon', department: 'Mechanical & Design' },
    { role: 'Programming Lead', name: 'Coming Soon', department: 'Software & Controls' },
    { role: 'Business Lead', name: 'Coming Soon', department: 'Operations & Outreach' },
    { role: 'Head Mentor', name: 'Coming Soon', department: 'Team Guidance' }
  ];
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <ScrollReveal delay={200}>
            <PremiumCard className="max-w-4xl mx-auto p-12 text-center mb-20">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                To inspire and equip young people to become leaders in STEM while demonstrating Christian values 
                through innovative robotics, community outreach, and gracious professionalism. We believe that 
                every student has the potential to change the world through STEM, and we're committed to providing 
                the tools, mentorship, and opportunities to make that happen.
              </p>
            </PremiumCard>
          </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              {[
                { icon: Users, value: '48', label: 'Team Members' },
                { icon: Award, value: '22', label: 'Mentors' },
                { icon: TrendingUp, value: '14', label: 'Years Active' },
