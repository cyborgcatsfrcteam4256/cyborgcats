...
-- Drop all existing policies on storage.objects for resumes and user-photos buckets
...
-- Resumes bucket policies (private bucket with restricted access)
...
-- User-photos bucket policies (now private with connection-based access)
